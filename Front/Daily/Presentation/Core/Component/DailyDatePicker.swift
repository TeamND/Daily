...
struct DailyDatePicker: View {
    ...
    var body: some View {
        Group {
            Label("\(CalendarServices.shared.formatDateString(year: currentDate.year, month: currentDate.month, day: currentDate.day, joiner: .dot, hasSpacing: true))\(currentDate.getKoreaDOW())", systemImage: "calendar")
